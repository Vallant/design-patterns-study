 ...
 */
public class PersonalStatisticControllerCached implements PersonalStatisticController
{
  ...
  public PersonalStatisticControllerCached(ControllerCache cache)
  {
    this.cache = cache;
  }
  ...
  public void projectPeriodChanged(int selectedIndex)
  {
    try
    {
      Pair<String, Integer> pair = new Pair("project", selectedIndex);
      if(cache.contains(pair.hashCode()))
      {
        Pair<ArrayList<Project>, ArrayList<Duration>> data = cache.get()
      }
